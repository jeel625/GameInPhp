...
echo<<<_END
    <html>
        ...
        <body>
        <h1 id='game'>This is Game Level 2</h1> 
...
?>  
        ...
        <form method="post" action="gameLevel2.php">
            <h1>Sort Numbers in descending Order :
            ...
            <input type="submit" name="send" value="SEND IT" style="color:white;background-color: #47614F;width:200px;height:40px;font-size:20px" required="required"/>
        </form>
        </h1>
        </body>
    </html>
...
{   
    ...
    if(isLettersInDescList($randomString,$input_letters))
    {
        ...
        echo "<h1> You have completed Level 2 <br>";
        echo "<a href='../../homepage/homepage.php'>Go Back To Login Page</a><br>";
        echo "<a href='../GameFiles/gameLevel3.php'>Go To Next Level</a>";
    }
    else
    {
        include('../../classDatabase/Database.php');  
