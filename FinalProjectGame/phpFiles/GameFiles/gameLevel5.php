...
echo<<<_END
    <html>
        ...
        <body>
        <h1 id='game'>This is Game Level 5</h1> 
...
?>  
        ...
        <form method="post" action="gameLevel5.php">
            <h1>Identify first and last letters from a set of letters :
...
{   
    ...
    echo "<br>";
    $first=$inputLetters[0];
    $last=$inputLetters[1];
    
    
    if(isFirstAndLastOfSet($randomString,$first,$last))
    {
        ...
        echo "<h1>You have completed Level 5<br>";
        echo "<a href='../../homepage/homepage.php'>Go Back To Login Page</a><br>";
        echo "<a href='../GameFiles/gameLevel6.php'>Go To Last Level</a><br>";
    }
    else
    {
        include('../../classDatabase/Database.php');  
