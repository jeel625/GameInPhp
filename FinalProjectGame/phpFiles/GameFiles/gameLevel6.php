...
echo<<<_END
    <html>
        ...
        <body>
        <h1 id='game'>This is Game Level 6</h1> 
...
?>  
        ...
        <form method="post" action="gameLevel6.php">
            <h1>Identify The Minimum & Maximum :
...
{   
    ...
    $min=$inputLetters[0];
        ...
        if(isMinAndMax($randomString,$min,$max))
        {
            echo<<<_END
        <html>
            <head>
        ...
        _END;
            ...
            $sql_select_query = "UPDATE login SET result ='PASS'  WHERE TempPassword= '$password' and UserName = '$userN'";
            $select_query = $connection->query($sql_select_query);
            echo "<img src=\"./360_F_267115523_nhJWtLVlhtYtqGkfVOIzhOCAjQRrejVI.jpg\"><br>";
            echo "<h1>You have completed All Levels..!!<br>";
