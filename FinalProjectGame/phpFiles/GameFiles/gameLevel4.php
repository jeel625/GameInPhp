...
?>  
        ...
        <form method="post" action="gameLevel4.php">
...
{   
    ...
    {
        if(isNumbersInDescOrder($randomString,$inputLetters))
        {
            echo<<<_END
        <html>
            <head>
        ...
        _END;
            ...
            echo "<h1>You have completed Level 4<br>";
            echo "<a href='../../homepage/homepage.php'>Go Back To Login Page</a><br>";
            echo "<a href='../GameFiles/gameLevel5.php'>Go To Next Level</a>";
        }
        else
        {
            include('../../classDatabase/Database.php');  
        ...
        echo "Incorrect – Your numbers have not been correctly ordered in decending order ";
